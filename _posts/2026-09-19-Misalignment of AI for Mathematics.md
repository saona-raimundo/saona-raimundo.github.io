...
I call you to have a look at [a letter signed by 26 Field Medal winners](https://mathandai.org/).

When so many prominent people in a field get coordinated to give one message, then we should build our own opinion. Here is mine.

1. Yes, the development of Mathematics is much more than solving problems. Problems are distillations of abstraction over real-world situations. Big problems moreover are used as benchmarks for related ideas, they are not the objective! Moreover, a good mathematician does not simply "find the proof of a theorem", they have to engage with the community, teach it, discuss it, find applications of the new theory, make it explainable.

The letter appeals to the fact that, if AI companies want to help Mathematics, then think about the whole process of how Mathematics progresses, not only how to attract funding by "solving" difficult problems.

2. Many colleagues think that, after AI evolves into super-mathematician, the profession of Math will be left for the people who "have the time", like it was in the past where most of the development was done by rich people, or those who had a patreon. The "democracy" and "gloabl reach" that Math has been building over the years would be lost, and that is a heavy price to pay.

3. If frontier AI labs are using "AI for X", then make sure that the X field is getting benefits, otherwise it is an irresponsible use of AI.

What is your opinion?

Here is a screenshot of the letter for reference.
